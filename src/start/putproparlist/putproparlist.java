        ...
        try {
            ...
            if(rs.next()){
                ...
                if(rs.next()){
                    ...
                    rs.close();
                    ps.close();
                    ps = conn.prepareStatement("UPDATE proparlist SET user = ?,dwgno = ?,dwgno1 = ?,dwgno2 = ?,productname_id_prodname = ?," +
                            ...
                            "proheight = ?,length = ?,designdate = ?,deconame = ? WHERE dwgno = ? AND audit = ?");
