...
public class searchdatacontraststanddata {
    private ArrayList<Double> aweldmaxangul;
    private ArrayList<Double> bweldmaxangul;
    private ArrayList<Double> aweldmaxalign;
    private ArrayList<Double> bweldmaxalign;
    private ArrayList<Double> weldreinfs;
    private ArrayList<Double> weldreinfd;
    private double proheight;
    private ArrayList<Double> innerdia;
    private ArrayList<Double> roundness;
