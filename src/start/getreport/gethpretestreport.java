...
@Controller
@CrossOrigin
public class gethpretestreport {                                        //液（水）压试验过程卡报表
    @RequestMapping(value = "gethpretestreport")
    public @ResponseBody ResponseEntity<byte[]> gethpretestreport(String prodno, String name, HttpServletRequest request) throws ClassNotFoundException, SQLException, IOException {
        jdbc j = new jdbc();
