            ...
            if(rsru.next()){
                if(!(sp.getMatlcode()==null || sp.getMatlcode().equals(""))){
                    if(!(sp.getMatlcode().charAt(0)!=rsru.getString("plank").charAt(0) &&
                            ...
                            sp.getMatlcode().charAt(0)!=rsru.getString("flange").charAt(0) &&
                            sp.getMatlcode().charAt(0)!=rsru.getString("head").charAt(0) &&
                            sp.getMatlcode().charAt(0)!=rsru.getString("welding").charAt(0)
                    )
                    ){
